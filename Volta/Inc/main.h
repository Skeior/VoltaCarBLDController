...
#define M1_BEMF_U_Pin GPIO_PIN_12
#define M1_BEMF_U_GPIO_Port GPIOB
#define M1_BUS_VOLTAGE_Pin GPIO_PIN_13
#define M1_BUS_VOLTAGE_GPIO_Port GPIOB
#define M1_BEMF_V_Pin GPIO_PIN_14
#define M1_BEMF_V_GPIO_Port GPIOB
#define M1_BEMF_W_Pin GPIO_PIN_15
